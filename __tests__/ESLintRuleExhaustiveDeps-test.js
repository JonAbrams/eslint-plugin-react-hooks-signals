...
const ReactHooksESLintPlugin = require("../dist/index");
const ReactHooksESLintRule =
  ReactHooksESLintPlugin.rules["exhaustive-deps-signals"];
  ...
  invalid: [
    {
      ...
      errors: [
        {
          message:
            "React Hook useEffect has a missing dependency: 'counterSignal.value'. " +
            "Either include it or remove the dependency array.",
          suggestions: [
            {
              desc: "Update the dependencies array to be: [counterSignal.value]",
      ...
      errors: [
        {
          message:
            "React Hook useEffect has a missing dependency: 'counterSignal.value'. " +
            "Either include it or remove the dependency array. " +
            "Outer scope values like 'counterSignal' aren't valid dependencies " +
      ...
      errors: [
        {
          ...
          suggestions: [
            {
              desc: "Update the dependencies array to be: [counterSignal, counterSignal.value]",
              output: normalizeIndent`
                function MyComponent() {
                  const counterSignal = useSignal(0);
                  useEffect(() => {
